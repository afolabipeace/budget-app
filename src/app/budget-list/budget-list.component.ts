...
export class BudgetListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.remain <= ((10 / 100) * this.total)) {
      ...
      let get = JSON.parse(localStorage.getItem("budget_array")!);
      this.budget_array = get
      this.remain = this.budget_array[this.id - 1].remain
    }
  ...
  edit(id: any) {
    alert('Unpurchase before edit')
    // let check = confirm('are you sure you wants edit this item unpurchase to edit')
    // if (check == true) {
